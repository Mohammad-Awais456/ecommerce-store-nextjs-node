...
function Cpanel() {
  ...
  return (
     ...
     <Banner title={"Control Panel"}/>
     <main  className={CreateClasses("container",style.signIn_page_container,style.cPanel_page_container)}>
...

{
  is_form_edited &&
       ...
       <div className={style.admin_controls}>
        <div className={style.wrapper}>

        <Link href="/admin/users" className="button-1">Manage Users</Link>
        <Link href="/admin/orders" className="button-1">Manage Orders</Link>
        <Link href="/admin/products" className="button-1">Manage Products</Link>
        <Link href="/admin/reviews" className="button-1">Manage Reviews</Link>
        <Link href="/admin/settings" className="button-1">Manage Settings</Link>
        </div>
       </div>
